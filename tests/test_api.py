...
from theaters_app.models import Theater, Performance, Ticket
...
TheaterApiTest = create_apitest(Theater, '/api/theaters/', {'title': 'Название', 'address': 'Анархии 12', 'rating': 4})
PerformanceApiTest = create_apitest(Performance, '/api/performances/', {'title': 'Название', 'description': 'Описание', 'date': '2040-02-23'})
TicketApiTest = create_apitest(Ticket, '/api/tickets/', {'price': 100, 'time': '11:36:59', 'place': '12'})
